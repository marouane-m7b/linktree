...
const skills = [
  ...
  {name: "Scrum", icon: DiScrum, category: "methodologies", color: "#0052CC" },
  {name: "UML", icon: SiUml, category: "methodologies", color: "#F24E1E" },
  {name: "Waterfall", icon: MdOutlineWaterfallChart, category: "methodologies", color: "#F24E1E" },
  {name: "MVC", icon: SiBlackmagicdesign, category: "methodologies", color: "#61DAFB" },
  {name: "REST API", icon: TbApi, category: "methodologies", color: "#FFFFFF" },
];

const operatingSystems = [
  {
    name: "Windows 7/10/11",
    icon: ImWindows,
    category: "os",
    color: "#0078D6",
  },
...
const SkillsSection = () => {
  ...
  const categories = [
    ...
    { id: "methodologies", label: translations.skills.categories.methodologies },
  ];
  ...
  const languageSkills = [
    {
      lang: "Arabic",
      flag: "🇲🇦",
      level: translations.skills.languageLevels.native,
    },
    {
      lang: "French",
      flag: "🇫🇷",
      level: translations.skills.languageLevels.intermediate,
    },
    {
      lang: "English",
      flag: "🇺🇸",
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {operatingSystems.map((os, index) => (
              <div key={index} className="group relative">
                <div className="flex items-center gap-3 px-6 py-4 rounded-xl bg-card border border-primary/20 hover:border-primary/50 transition-all hover:scale-105">
                  <div

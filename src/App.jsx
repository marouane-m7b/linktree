...
// 1. FIX: Move Background component OUTSIDE to prevent focus loss
      ...
      <div className="bg-white/90 backdrop-blur-lg rounded-2xl shadow-xl p-8 w-full border border-white/50">
        ...
        <div className="space-y-6">
          <div className="relative">
            {/* 3. FIX: Show/Hide Password Feature */}
            <input
              ...
              disabled={isLocked}
              // Added pr-12 (padding-right) to make room for the eye icon
              className="w-full pl-4 pr-12 py-4 bg-gray-50 border border-gray-200 rounded-xl focus:ring-4 focus:ring-purple-100 focus:border-purple-500 outline-none transition-all text-center text-lg tracking-widest disabled:opacity-50"
              placeholder="••••••••"
              autoComplete="off"
            />
